...
description: Push a weighted platform away using your legs—adjust foot placement (higher for glutes/hamstrings, lower for quads) and avoid locking out your knees.
tags:
  - exercise
  - leg
type:
