...
shortName: bentOverRow
imagePath: "[[bentOverRow.png]]"
description: The Single-Arm Dumbbell Bent-Over Row (Bench-Supported) involves placing one hand and knee on a bench, rowing a dumbbell with the other hand toward your hip while keeping your back parallel to the ground. It builds a thicker back and stronger arms, complementing your pull day core by targeting muscles with a controlled, unilateral pull.
tags:
  - exercise
  - pull
type:
