...
shortName: cable-lowRow
imagePath: "[[cableLowRow.png]]"
description: The Low Cable Row (Neutral Grip) involves sitting at a cable machine, grabbing handles with palms facing each other, and pulling them toward your waist. It builds your mid-back (rhomboids, traps), lats, and biceps, giving you a thicker, stronger back.
tags:
  - exercise
  - pull
type:
